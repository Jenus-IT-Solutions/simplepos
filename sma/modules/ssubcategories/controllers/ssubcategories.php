...
class Ssubcategories extends MX_Controller
{
...
function index() {
    $output['res'] = $this->_custom_query('SELECT * FROM products WHERE subcategory_id = 1');//$this->get('id');
    
    $this->load->view('subcategories', $output);
